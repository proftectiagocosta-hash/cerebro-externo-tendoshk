# Prompt-Mestre de Retomada Operacional do Cérebro Tendoshk — V1.1
...
Destino de documentos integrais canônicos de natureza contratual, protocolar, normativa, especificacional, bootstrap, checkpoint, módulos e peças equivalentes do núcleo.
